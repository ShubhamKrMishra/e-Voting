export default function Footer() {
    ...
    <footer class="p-4 z-[-1] md:z-10 fixed bottom-0 left-0 w-screen bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href={`http://${window.location.host}`} class="hover:underline">Online Voting</a>. All Rights Reserved.
        </span>
