...
export default function SidebarWelcomePage({ changePage }) {
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <aside
        class=" overflow-y-auto shadow bg-white dark:bg-gray-800 md:block flex-shrink-0 w-full absolute top-0 z-20"
      >
        <div class="py-0 text-gray-500 dark:text-gray-400 flex items-center w-full">
          ...
          <ul class="mt-2 flex w-full z-100">
          ...
          <div class="mr-5 flex">
            ...
            <SidebarButton name={'voterLogin'} link={'/voterLogin'} selectPage={selectPage} />
          </div>
        </div>
      </aside>
